...
#ifndef SEISFILE_HDFS_TRACEUPDATER_H_
#define SEISFILE_HDFS_TRACEUPDATER_H_
...
class TraceUpdaterHDFS : public TraceUpdater{
public:

    /**
     * Destructor.
     */
    virtual ~TraceUpdaterHDFS(){};

    TraceUpdaterHDFS(const std::string& filename);
...
#endif /* SEISFILE_HDFS_TRACEUPDATER_H_ */
