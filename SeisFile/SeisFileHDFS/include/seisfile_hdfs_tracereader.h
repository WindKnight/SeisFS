...
#ifndef SEISFILE_HDFS_TRACEREADER_H_
#define SEISFILE_HDFS_TRACEREADER_H_
...
class TraceReaderHDFS : public TraceReader{
public:

    /**
     * Destructor.
     */
	virtual ~TraceReaderHDFS();

	//TraceReaderHDFS(const std::string& filename);
	TraceReaderHDFS(const std::string& filename, MetaHDFS *meta);
...
#endif /* SEISFILE_HDFS_TRACEREADER_H_ */
