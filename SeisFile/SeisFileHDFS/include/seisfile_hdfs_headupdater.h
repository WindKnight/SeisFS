...
#ifndef SEISFILE_HDFS_HEADUPDATER_H_
#define SEISFILE_HDFS_HEADUPDATER_H_
...
class HeadUpdaterHDFS : public HeadUpdater {
public:

    virtual ~HeadUpdaterHDFS(){};

    HeadUpdaterHDFS(const std::string& filename);
...
#endif /* SEISFILE_HDFS_HEADUPDATER_H_ */
