...
#ifndef SEISFILE_HDFS_WRITER_H_
#define SEISFILE_HDFS_WRITER_H_
...
class HeadWriterHDFS;
class TraceWriterHDFS;
class MetaHDFS;
//class GEFile;
...
public:
	...
	//WriterHDFS(const std::string& filename, MetaHDFS *meta);
	//WriterHDFS(const std::string& filename);
	 //WriterHDFS(const std::string& filename, const HeadType &head_type, const TraceType& trace_type, Lifetime lifetime_days);
