/*
 * garbage_collector_local.h
 *
 *  Created on: Dec 12, 2016
 *      Author: node1
 */

#ifndef GARBAGE_COLLECTOR_LOCAL_H_
#define GARBAGE_COLLECTOR_LOCAL_H_
...
namespace tmp {
/**
 * this class provides some function of expired local files remove.
 */
class GarbageCollectorLocal {
...
public:
     ...
     * constructor
     */
    GarbageCollectorLocal();

    /**
     * destructor
     */
    virtual ~GarbageCollectorLocal();
...
#endif /* GARBAGE_COLLECTOR_LOCAL_H_ */
