...
StorageArch storageArch = STORAGE_NAS;

BOOST_AUTO_TEST_SUITE(tmp_nas_test)

BOOST_AUTO_TEST_CASE(tmp_nas_1) {
    Dir *dir = Dir::New("", storageArch);
    BOOST_REQUIRE_EQUAL(dir->Remove(), true);
    delete dir;
}

BOOST_AUTO_TEST_CASE(tmp_nas_2) {
    File *file = File::New("", storageArch);
    delete file;
}

BOOST_AUTO_TEST_CASE(tmp_nas_3) {
...
BOOST_AUTO_TEST_CASE(tmp_nas_4) {
    Dir *dir = Dir::New("/folder", storageArch);
    BOOST_REQUIRE_MESSAGE(dir!=NULL, "dir is null");
    BOOST_REQUIRE_EQUAL(dir->Exist(), false);
    BOOST_REQUIRE_EQUAL(dir->MakeDirs(), true);
...
BOOST_AUTO_TEST_CASE(tmp_nas_5) {
...
BOOST_AUTO_TEST_CASE(tmp_nas_6) {
    Dir *dir = Dir::New("/folder", storageArch);
    BOOST_REQUIRE_MESSAGE(dir!=NULL, "dir is null");
    BOOST_REQUIRE_EQUAL(dir->Exist(), false);
    BOOST_REQUIRE_EQUAL(dir->MakeDirs(), true);
...
BOOST_AUTO_TEST_CASE(tmp_nas_7) {
...
BOOST_AUTO_TEST_CASE(tmp_nas_8) {
    Dir *dirFolder = Dir::New("/folder", storageArch);
    BOOST_REQUIRE_MESSAGE(dirFolder!=NULL, "dirFolder is null");
    BOOST_REQUIRE_EQUAL(dirFolder->MakeDirs(), true);
...
BOOST_AUTO_TEST_CASE(tmp_nas_9) {
    Dir *dirFolder = Dir::New("/folder", storageArch);
    BOOST_REQUIRE_MESSAGE(dirFolder!=NULL, "dirFolder is null");
    BOOST_REQUIRE_EQUAL(dirFolder->MakeDirs(), true);
...
BOOST_AUTO_TEST_CASE(tmp_nas_10) {
    Dir *dirFolder = Dir::New("/folder", storageArch);
    BOOST_REQUIRE_MESSAGE(dirFolder!=NULL, "dirFolder is null");
    BOOST_REQUIRE_EQUAL(dirFolder->MakeDirs(), true);
...
BOOST_AUTO_TEST_CASE(tmp_nas_11) {
...
BOOST_AUTO_TEST_CASE(tmp_nas_12) {
    KVTable *table = KVTable::New("TravelTime", storageArch);
    BOOST_REQUIRE_MESSAGE(table!=NULL, "table is null");
    BOOST_REQUIRE_EQUAL(table->Open(30, CMP_NON, CACHE_L1), true);
...
BOOST_AUTO_TEST_CASE(tmp_nas_13) {
    KVTable *table = KVTable::New("TravelTime", storageArch);
    BOOST_REQUIRE_MESSAGE(table!=NULL, "table is null");
    BOOST_REQUIRE_EQUAL(table->Open(30, CMP_NON, CACHE_L1), true);
...
BOOST_AUTO_TEST_CASE(tmp_nas_14) {
    KVTable *table = KVTable::New("TravelTime", storageArch);
    BOOST_REQUIRE_MESSAGE(table!=NULL, "table is null");
    BOOST_REQUIRE_EQUAL(table->Open(30, CMP_NON, CACHE_L1), true);
...
BOOST_AUTO_TEST_CASE(tmp_nas_15) {
    KVTable *table = KVTable::New("TravelTime", storageArch);
    BOOST_REQUIRE_MESSAGE(table!=NULL, "table is null");
...
BOOST_AUTO_TEST_CASE(tmp_nas_16) {
    KVTable *table = KVTable::New("TravelTime", storageArch);
    BOOST_REQUIRE_MESSAGE(table!=NULL, "table is null");
    BOOST_REQUIRE_EQUAL(table->Open(30, CMP_GZIP, CACHE_L1), true);
...
BOOST_AUTO_TEST_CASE(tmp_nas_17) {
    KVTable *table = KVTable::New("TravelTime", storageArch);
    BOOST_REQUIRE_MESSAGE(table!=NULL, "table is null");
    BOOST_REQUIRE_EQUAL(table->Open(30, CMP_GZIP, CACHE_L1), true);
    BOOST_REQUIRE_EQUAL(table->Exists(), true);
...
BOOST_AUTO_TEST_CASE(tmp_nas_18) {
    KVTable *table = KVTable::New("TravelTime", storageArch);
    BOOST_REQUIRE_MESSAGE(table!=NULL, "table is null");
    BOOST_REQUIRE_EQUAL(table->Open(30, CMP_GZIP, CACHE_L1), true);
...
BOOST_AUTO_TEST_CASE(tmp_nas_19) {
