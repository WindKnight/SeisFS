...
#ifndef SEISFILE_NAS_KVINFO_H_
#define SEISFILE_NAS_KVINFO_H_
...
class KVInfoNAS : public KVInfo {
public:

	KVInfoNAS(const std::string& filename);
...
//    const std::string SEISNAS_HOME_PATH = "/d0/data/seisfiletest/seisfiledisk/kvinfo/";
